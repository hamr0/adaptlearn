// M1 exit criteria: the valid fixture passes; each red fixture produces its ONE
// distinct named red (code + path), before any execution. Table-driven over
// tests/fixtures/ — one fixture per named red, each isolating a single defect.
...
// ---- diffPaths: the one-knob mutation checker (design §Decisions 4) ----
